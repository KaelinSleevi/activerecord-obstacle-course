...
# ----------------------
  ...
  it '2. finds order id of smallest order' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    # Solution goes here
    order_id = Order.select("orders.*").order("amount asc").limit(1).first[:id]
    # ------------------------------------------------------------
  ...
  it '3. finds order id of largest order' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    # Solution goes here
    order_id = Order.select("orders.*").order("amount desc").limit(1).first[:id]
  ...
  it '4. finds orders of multiple amounts' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    # Solution goes here
    orders_of_500_and_700 = Order.where("orders.amount = 500 or orders.amount = 700")
    orders_of_700_and_1000 = Order.where("orders.amount = 700 or orders.amount = 1000")
    # ------------------------------------------------------------
